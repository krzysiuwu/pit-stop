...
always_comb begin                                           //convervsion to 12-bit colors from lut values
        case (low_res_in.lut_value)
            4'h0: rgb_next = 12'h000;
            4'h1: rgb_next = 12'h333;
            4'h2: rgb_next = 12'h777;
            4'h3: rgb_next = 12'hCCC;
            4'h4: rgb_next = 12'hFFF;
            4'h5: rgb_next = 12'hF00;
            4'h6: rgb_next = 12'h900;
            4'h7: rgb_next = 12'hFF0;
            4'h8: rgb_next = 12'hF80;
            4'h9: rgb_next = 12'h0B0;
            4'hA: rgb_next = 12'h03A;
            4'hB: rgb_next = 12'h0AF;
            4'hC: rgb_next = 12'hFCA;
            4'hD: rgb_next = 12'h631;
            4'hE: rgb_next = 12'hF0A;
            4'hF: rgb_next = 12'hF0F;
