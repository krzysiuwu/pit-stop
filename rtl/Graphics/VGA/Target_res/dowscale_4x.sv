/**
 * Module: downscale_4x
 * Description: Downscales a 1024x768 resolution to a 256x192 virtual resolution.
 */
...
module downscale_4x (
     ...
     */
    assign low_res_out.hcount = vga_in.hcount >> 2;
    assign low_res_out.vcount = vga_in.vcount >> 2;
